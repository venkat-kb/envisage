...
import CoastalForm from "./coastal-form";
...
export default async function Page({
  ...
  let defaultData: ICoastalValidator | undefined;
  ...
  if (searchParams.editing || searchParams.recreating) {
    ...
    })) as unknown as CoastalShipmentData;
    if (!data) {
      return <>NOT FOUND</>;
    }
    defaultData = {
  ...
  return <CoastalForm data={data} state={state} defaultData={defaultData} />;
}
