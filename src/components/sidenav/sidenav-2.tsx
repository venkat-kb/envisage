...
//       <div className="inner max-w-max z-1">
...
const DATA = {
  navbar: [
    ...
    { href: "/dashboard/shipment/new", icon: Plus, label: "New Shipment" },
    { href: "/dashboard/shipment", icon: Truck, label: "Your Shipments" },
    { href: "/dashboard/compare", icon: PencilRuler, label: "Compare" },
    { href: "/dashboard/chat/new", icon: Bot, label: "Chat" },
...
export default function DockDemo() {
  return (
      <TooltipProvider>
        <Dock className="fixed bottom-4 left-[50%] translate-x-[-50%] z-[100]">
